...
// ALMUERZO (no requiere aprobación)
...
// CARTA DE INGRESOS (requiere aprobación)
router.post(  "/carta", verifyToken, authorizeRoles(1, 2, 3, 4, 5), solicitudCtrl.crearCarta);

// BOLETA DE PAGO (no requiere aprobación; requiere quincena/mes/año)
...
// SALIDA ANTICIPADA (requiere aprobación)
...
router.patch("/:id/aprobar", verifyToken,authorizeRoles(1,2, 3, 5), solicitudCtrl.aprobarSolicitud);
router.patch("/:id/rechazar", verifyToken, authorizeRoles(1,2, 3, 5),solicitudCtrl.rechazarSolicitud);
