      ...
      <div className="dashboard-layout">
        ...
        <header className="main-header">
          <div className="header-left">
            <div className="logo">
              <span className="logo-icon"><img src="/ROSMO.png" alt="Logo R" className="logo-img" /></span>
          ...
          <div className="header-right">
            ...
            <div className="profile-container">
              <img
                src={localStorage.getItem("usuario_foto") || `https://ui-avatars.com/api/?name=${usuario?.nombre || "U"}&background=ffffff&color=CC0000`}
                alt="Foto de perfil"
        ...
        <div className="dashboard-content">
          ...
          <aside className="sidebar">
            <div className="user-info">
              <img 
                src={localStorage.getItem("usuario_foto") || `https://ui-avatars.com/api/?name=${usuario?.nombre || "U"}&background=cc0000&color=fff`} 
                alt="Avatar" 
